...
> understand the full system, Eric's preferences, and operational context.
> Updated by IonBobcat on every sync.

*Last synced: 2026-02-13*

## About Eric (Our Human)
- **Name:** Eric (Eric Vicenti)
...
- **IonBobcat** (me, OpenClaw): Monitors you, triggers cycles, reports to Eric
...
- **Eric's user ID:** `usr_mldu5ohe-94448ee0`
...
- **Daily 9am report:** Sends Eric status update on Telegram
...
- **Priority updates:** Translates Eric's Telegram messages into PRIORITIES.md updates

## Things Leopard Should Eventually Own
- [ ] Self-triggering improvement cycles (internal scheduler, not external kicks)
- [ ] Telegram bot for direct communication with Eric
