...
export default function ProcessTerminalPage({ params }: ProcessTerminalPageProps) {
  const { processId, projectId: paramProjectId } = params;
  ...
  // Use projectId from params, process, or selected project
  const effectiveProjectId = paramProjectId || selectedProjectId || process.projectId;
