...
function WorkflowEditor() {
  ...
  const { data: workflow, isLoading, error } = useQuery({
    ...
    enabled: !!selectedProjectId && !!workflowId,
  });
      ...
      <div className="border-b border-border px-4 py-3 bg-bg-secondary">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={() => {
                // TODO: Execute workflow - for now show alert
                alert("Workflow execution coming soon!");
              }}
              className="flex items-center gap-2 px-3 py-1.5 bg-bg-elevated text-text-primary rounded hover:bg-bg-elevated/80 border border-border"
