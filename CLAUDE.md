...
**CRITICAL: For any UI feature, you MUST write Playwright e2e tests.**

Unit and integration tests only verify individual layers. E2E tests verify the full user flow works:
- API client parsing responses correctly
- React Query hooks working with real API responses
